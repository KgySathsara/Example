    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                @slot('subtitle') 2 Sidebars on 2 Sides @endslot
                @endcomponent
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-section">
                    <div class="sidebar-section-header border-bottom">
                        ...
                        <div class="ms-auto">
                            <a href="#sidebar_end_search" class="text-reset" data-bs-toggle="collapse">
                                <i class="ph-caret-down collapsible-indicator"></i>
                            </a>
                        </div>
                    </div>

                    <div class="collapse show" id="sidebar_end_search">
                ...
                <div class="sidebar-section">
                    <div class="sidebar-section-header border-bottom">
                        ...
                        <div class="ms-auto">
                            <a href="#sidebar_end_navigation" class="text-reset" data-bs-toggle="collapse">
                                <i class="ph-caret-down collapsible-indicator"></i>
                            </a>
                        </div>
                    </div>
